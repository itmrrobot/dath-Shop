            ...
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
                ...
                >
                    <StatBox
                        ...
                        progress="0.75"
                        increase="+14%"
                        icon={<EmailIcon sx={{ color: 'var(--primary)', fontSize: '26px' }} />}
                    />
                </Box>
                <Box
                    gridColumn="span 3"
                ...
                >
                    <StatBox
                        ...
                        progress="0.30"
                        increase="+5%"
                        icon={<PersonAddIcon sx={{ color: 'var(--primary)', fontSize: '26px' }} />}
                    />
                </Box>
                <Box
                    gridColumn="span 3"
                ...
                >
                    <StatBox
                        ...
                        progress="0.80"
                        increase="+43%"
                        icon={<TrafficIcon sx={{ color: 'var(--primary)', fontSize: '26px' }} />}
                    />
                </Box>
